package com.xuliwen.viewtest.widget;
...
public class ExampleAppWidgetProvider extends AppWidgetProvider {
    private static final String TAG = "EAWP";

    private boolean DEBUG = true;
    // 启动ExampleAppWidgetService服务对应的action
    private final Intent EXAMPLE_SERVICE_INTENT =
            new Intent("android.appwidget.action.EXAMPLE_APP_WIDGET_SERVICE").setPackage("xuliwen.cvtest");
