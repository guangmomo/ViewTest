...
public class CustomTextView extends View {
    ...
    private void initOnLongClickListener(){
        this.setOnLongClickListener(new OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                Log.e(Constants.VIEWEVENT,"TextView+OnLongClickListener");
                return true;
            }
        });
    }
    ...
    private void initOnTouchListener(){
        this.setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                Log.e(Constants.VIEWEVENT,"TextView+OnTouchListener");
                return false;
            }
        });
    }
    ...
    private void initOnClickListener(){
        this.setOnClickListener(new OnClickListener()
        {
            ...
            {
                Log.e(Constants.VIEWEVENT,"TextView+OnClickListener");
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()){
            ...
            case MotionEvent.ACTION_UP:
                result= super.onTouchEvent(event);//super.onTouchEvent内部会处理OnClickListener(),OnLongClickListener
                break;
        }
        Log.e(Constants.VIEWEVENT,"TextView+onTouchEvent"+"+"+result);
        return result;
    }
